...
%.zip:
	...
	npm run build
	mkdir -p nodejs
	npm install --prefix nodejs/ tar-fs@3.0.5 follow-redirects@1.15.5 playwright-core@1.42.1 --bin-links=false --fund=false --omit=optional --omit=dev --package-lock=false --save=false
	npm pack
